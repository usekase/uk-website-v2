    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-32 pb-12 px-3 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <Card
            variant="corners"
            className="p-4 sm:p-8 md:p-12 lg:p-16 bg-white dark:bg-zinc-900"
          >
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Textarea
                        ...
                        onChange={handleChange}
                        placeholder="Share your business AI transformation goals / partnership interest / investment plans"
