    ...
    >
      ...
      <div className="relative w-full h-full">
        <img
          ...
          draggable="false"
        />
        {/* After Label on right - only visible on before image */}
        {afterLabel && (
          <div className="absolute top-6 right-6 bg-black/60 text-white px-6 py-3 rounded-lg font-bold text-2xl shadow-xl backdrop-blur-sm pointer-events-none">
            {afterLabel}
          </div>
        )}
      </div>
      ...
      >
        <img
          ...
          draggable="false"
        />
        {/* Before Label on left - only visible on after image */}
        {beforeLabel && (
          <div className="absolute top-6 left-6 bg-black/60 text-white px-6 py-3 rounded-lg font-bold text-2xl shadow-xl backdrop-blur-sm pointer-events-none">
            {beforeLabel}
          </div>
        )}
      </div>
